...
export default function AdminScreen() {
  ...
  const { data: analyticsData } = useQuery({ queryKey: ['admin-analytics', token], queryFn: () => adminAnalytics(token!), enabled: Boolean(token && user?.role === 'admin'), staleTime: 60_000 });
...
const styles = StyleSheet.create({
  ...
  commentsLinkText: { color: colors.ink, flex: 1, fontSize: 12, fontWeight: '900' },
  ...
  analyticsEyebrow: { color: colors.accent, fontSize: 9, fontWeight: '900', letterSpacing: 1.3 },
  analyticsTitle: { color: colors.ink, fontSize: 16, fontWeight: '900', marginTop: 3 },
  analyticsTotals: { alignItems: 'flex-end' },
  analyticsNumber: { color: colors.ink, fontSize: 18, fontWeight: '900' },
  analyticsLabel: { color: colors.muted, fontSize: 9, fontWeight: '800' },
  ...
  analyticsEvent: { color: colors.muted, fontSize: 11, textTransform: 'capitalize' },
  analyticsCount: { color: colors.accent, fontSize: 11, fontWeight: '900' },
