...
const styles = StyleSheet.create({
  ...
  analyticsErrorText: { color: colors.muted, fontSize: 11, lineHeight: 16, flex: 1 },
  analyticsRetry: { color: colors.accent, fontSize: 11, fontWeight: '900' },
