...
const styles = StyleSheet.create({
  ...
  loadingResults: { flexDirection: 'row', alignItems: 'center', gap: 9, borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, backgroundColor: colors.surface, padding: spacing.md },
  loadingResultsText: { color: colors.muted, fontSize: 11, fontWeight: '800' },
