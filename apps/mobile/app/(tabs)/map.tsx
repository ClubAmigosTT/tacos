...
export default function MapScreen() {
  ...
  }, [active, data, displayedTaco, radarDistance, radarMood, radarPrice]);
  ...
  return (
    <View style={styles.screen}>
      <MapCanvas places={sorted} active={active} tacoName={displayedTaco} onSelect={(id) => router.push(`/place/${id}`)} userCoordinates={coordinates} onRegionChangeComplete={handleMapRegionChange} />
