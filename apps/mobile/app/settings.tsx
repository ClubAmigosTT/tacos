...
export default function SettingsScreen() {
  ...
  if (!user) return <View style={styles.center}><Ionicons name="person-circle-outline" size={42} color={colors.tortilla} /><Text style={styles.title}>Entra para editar tu perfil</Text><Pressable style={styles.primary} onPress={() => router.push('/auth')}><Text style={styles.primaryText}>Entrar</Text></Pressable></View>;
...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: colors.textPrimary, fontSize: 28, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, marginTop: 3 },
  ...
  avatar: { width: 56, height: 56, borderRadius: 28, backgroundColor: colors.tortilla, alignItems: 'center', justifyContent: 'center' },
  avatarText: { color: colors.background, fontSize: 23, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  identityCopy: { flex: 1 },
  identityName: { color: colors.textPrimary, fontSize: 17, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  identityEmail: { color: colors.textSecondary, fontSize: 11, fontFamily: typography.fontFamily.regular, marginTop: 4 },
  sectionLabel: { color: colors.tortilla, fontSize: 9, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, letterSpacing: 1.4, marginTop: spacing.lg, marginBottom: spacing.md },
  label: { color: colors.textTertiary, fontSize: 9, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, letterSpacing: 1.2, marginBottom: 8 },
  input: { minHeight: 52, borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, backgroundColor: colors.surface, color: colors.textPrimary, paddingHorizontal: 14, fontSize: 15 },
  help: { color: colors.textSecondary, fontSize: 12, fontFamily: typography.fontFamily.regular, lineHeight: 18, marginTop: 8 },
  error: { color: colors.danger, fontSize: 12, fontFamily: typography.fontFamily.regular, lineHeight: 17, marginTop: spacing.md },
  primary: { minHeight: 52, borderRadius: radii.md, backgroundColor: colors.tortilla, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 7, marginTop: spacing.xl },
  ...
  link: { flexDirection: 'row', alignItems: 'center', gap: 11, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, borderRadius: radii.md, padding: spacing.md, marginBottom: spacing.sm },
  linkIcon: { width: 34, height: 34, borderRadius: 10, backgroundColor: colors.surfaceRaised, alignItems: 'center', justifyContent: 'center' },
  linkCopy: { flex: 1 },
  linkTitle: { color: colors.textPrimary, fontSize: 13, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  linkDetail: { color: colors.textSecondary, fontSize: 11, fontFamily: typography.fontFamily.regular, marginTop: 3 },
  title: { color: colors.textPrimary, fontSize: 24, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, marginTop: spacing.md },
  muted: { color: colors.textSecondary, fontSize: 13 },
  dangerLink: { flexDirection: 'row', alignItems: 'center', gap: 9, paddingVertical: spacing.lg },
  dangerText: { color: colors.danger, fontSize: 13, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
});
