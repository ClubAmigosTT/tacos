...
const styles = StyleSheet.create({
  ...
  visibilityLabel: { color: colors.dim, fontSize: 9, fontWeight: '900', letterSpacing: 1.2, marginBottom: 7 },
  visibilityOptions: { flexDirection: 'row', gap: 8 },
  visibilityOption: { flexDirection: 'row', alignItems: 'center', gap: 5, borderWidth: 1, borderColor: colors.border, borderRadius: radii.pill, paddingHorizontal: 11, paddingVertical: 8, backgroundColor: colors.surfaceRaised },
