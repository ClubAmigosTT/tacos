...
const styles = StyleSheet.create({
  ...
  peopleButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.tortilla, alignItems: 'center', justifyContent: 'center' },
  loginCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.tortilla, borderRadius: radii.md, padding: spacing.md },
  ...
  avatar: { width: 38, height: 38, borderRadius: 19, backgroundColor: colors.salsa, alignItems: 'center', justifyContent: 'center' },
  avatarText: { color: colors.background, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  itemCopy: { flex: 1 },
  itemTitle: { color: colors.textPrimary, fontSize: 13 },
  bold: { fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  itemTime: { color: colors.textSecondary, fontSize: 10, fontFamily: typography.fontFamily.regular, marginTop: 4 },
  ...
  placeCopy: { flex: 1 },
  placeName: { color: colors.textPrimary, fontSize: 14, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  placeMeta: { color: colors.textSecondary, fontSize: 11, fontFamily: typography.fontFamily.regular, marginTop: 4 },
  itemNote: { color: colors.salsa, fontSize: 12, fontFamily: typography.fontFamily.regular, lineHeight: 18, fontStyle: 'italic', marginTop: spacing.md, paddingTop: spacing.md, borderTopWidth: 1, borderTopColor: colors.border },
  ...
  commentsText: { color: colors.textSecondary, flex: 1, fontSize: 11, fontFamily: typography.fontFamily.semibold, fontWeight: typography.weight.semibold },
  ...
  emptyText: { color: colors.textSecondary, fontSize: 13, fontFamily: typography.fontFamily.regular, lineHeight: 19, textAlign: 'center', marginTop: 6 },
  primary: { backgroundColor: colors.tortilla, borderRadius: radii.md, paddingHorizontal: spacing.lg, paddingVertical: 13, marginTop: spacing.lg },
