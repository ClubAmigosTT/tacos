...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: colors.textPrimary, fontSize: 22, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, marginTop: 3 },
  ...
  date: { color: colors.textTertiary, fontSize: 10 },
  commentBody: { color: colors.textSecondary, fontSize: 13, fontFamily: typography.fontFamily.regular, lineHeight: 19, marginTop: 5 },
  delete: { flexDirection: 'row', alignItems: 'center', gap: 4, alignSelf: 'flex-start', marginTop: 8 },
  deleteText: { color: colors.salsa, fontSize: 10, fontFamily: typography.fontFamily.semibold, fontWeight: typography.weight.semibold },
  ...
  input: { flex: 1, minHeight: 44, maxHeight: 110, borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, backgroundColor: colors.surfaceRaised, color: colors.textPrimary, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13 },
  send: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.tortilla, alignItems: 'center', justifyContent: 'center' },
