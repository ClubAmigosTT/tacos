...
export default function RegisterScreen() {
  ...
  async function save() {
    ...
    setError('');
    try {
      await createVisit({ placeId, tacoIds, rating, tacoRatings, price: price ? Number(price) : undefined, note: note.trim() || undefined }, token);
      setSaved(true);
    } catch {
