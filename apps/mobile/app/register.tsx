...
export default function RegisterScreen() {
  ...
  function acceptPhotoSuggestion() {
    ...
    if (suggestion.tacoId) {
      ...
      setTacoRatings({ [suggestion.tacoId]: rating });
    }
    setPhotoSuggestion(undefined);
  }
...
const styles = StyleSheet.create({
  ...
  ratingValue: { color: colors.textSecondary, fontFamily: typography.fontFamily.semibold, fontSize: 17, fontWeight: typography.weight.semibold },
  ratingValueActive: { color: colors.meatDark },
  ratingHint: { color: colors.textSecondary, fontFamily: typography.fontFamily.regular, fontSize: 12, marginTop: 10 },
