...
const styles = StyleSheet.create({
  ...
  label: { color: colors.textTertiary, fontSize: 9, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, letterSpacing: 1.2, marginTop: spacing.md, marginBottom: 7 },
  input: { minHeight: 50, borderRadius: radii.md, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, color: colors.textPrimary, paddingHorizontal: 13, fontSize: 14 },
  ...
  optionText: { color: colors.textSecondary, fontSize: 12, fontFamily: typography.fontFamily.semibold, fontWeight: typography.weight.semibold },
