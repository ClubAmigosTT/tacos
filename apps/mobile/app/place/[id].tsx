...
export default function PlaceScreen() {
  ...
  const { data: googlePhotoData, isLoading: googlePhotosLoading } = useQuery({ queryKey: ['google-photos', id], queryFn: () => googleBranchPhotos(id), enabled: Boolean(id && place && !hasCatalogPhotos), staleTime: 0, gcTime: 0, retry: false, refetchOnMount: 'always' });
