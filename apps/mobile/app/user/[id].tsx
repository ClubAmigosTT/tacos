...
const styles = StyleSheet.create({
  ...
  followError: { color: colors.danger, fontSize: 11, lineHeight: 16, textAlign: 'center', marginTop: 8, maxWidth: 260 },
