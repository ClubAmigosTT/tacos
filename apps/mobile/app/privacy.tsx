...
export default function PrivacyScreen() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (result) => { setShareActivity(result.privacy.shareActivity); void queryClient.invalidateQueries({ queryKey: ['feed'] }); },
