...
const styles = StyleSheet.create({
  ...
  copy: { flex: 1 },
  rowTitle: { color: colors.textPrimary, fontSize: 14, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  rowDetail: { color: colors.textSecondary, fontSize: 11, fontFamily: typography.fontFamily.regular, lineHeight: 16, marginTop: 4 },
  ...
  noteText: { flex: 1, color: colors.textSecondary, fontSize: 11, fontFamily: typography.fontFamily.regular, lineHeight: 16 },
