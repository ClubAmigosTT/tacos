...
export default function StatsScreen() {
  ...
  const sourceEntries: StatsEntry[] = data?.entries ?? (token || !isDemoMode() ? [] : diaryEntries.map((entry) => ({ rating: entry.rating, place_name: entry.place, neighborhood: 'CDMX', tacos: entry.taco, price: null })));
...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: colors.tortilla, borderRadius: radii.lg, padding: spacing.lg, minHeight: 205, position: 'relative', overflow: 'hidden', marginBottom: spacing.lg },
  ...
  heroEyebrow: { color: colors.background, fontSize: 9, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, letterSpacing: 1.4 },
  heroTitle: { color: colors.background, fontSize: 27, fontFamily: typography.fontFamily.bold, lineHeight: 30, fontWeight: typography.weight.bold, letterSpacing: -0.8, maxWidth: 285, marginTop: 22 },
  heroCopy: { color: colors.background, opacity: 0.72, fontSize: 12, fontFamily: typography.fontFamily.regular, lineHeight: 18, maxWidth: 285, marginTop: 12 },
  ...
  sectionEyebrow: { color: colors.tortilla, fontSize: 9, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, letterSpacing: 1.4 },
  sectionTitle: { color: colors.textPrimary, fontSize: 21, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, letterSpacing: -0.4, marginTop: 4 },
  ...
  barValue: { color: colors.tortilla, fontSize: 10, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, height: 13 },
  ...
  barFill: { width: '100%', backgroundColor: colors.tortilla, borderRadius: 7 },
  barLabel: { color: colors.textSecondary, fontSize: 9, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  chartHint: { color: colors.textTertiary, fontSize: 10, fontFamily: typography.fontFamily.regular, marginTop: 15 },
  ...
  rankText: { color: colors.tortilla, fontSize: 10, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold },
  rowName: { color: colors.textPrimary, fontSize: 14, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, flex: 1 },
  rowValue: { color: colors.textSecondary, fontSize: 11, fontFamily: typography.fontFamily.semibold, fontWeight: typography.weight.semibold },
  ...
  cta: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.tortilla, borderRadius: radii.md, padding: spacing.lg },
  ctaTitle: { color: colors.background, fontSize: 14, fontFamily: typography.fontFamily.bold, fontWeight: typography.weight.bold, flex: 1 },
