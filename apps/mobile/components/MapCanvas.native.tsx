...
export function MapCanvas({ places, active, onSelect, userCoordinates }: { places: Place[]; active: string; onSelect: (id: string) => void; userCoordinates?: { latitude: number; longitude: number } }) {
