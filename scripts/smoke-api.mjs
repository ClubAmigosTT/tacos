...
const punctuationSearch = await request('/v1/discover?q=%21%21%21&limit=10');
if (punctuationSearch.places?.length !== 0) throw new Error('Punctuation-only discovery query should not return the full catalog');
